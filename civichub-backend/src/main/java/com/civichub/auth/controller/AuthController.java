...
public class AuthController {
    ...
    @Operation(summary = "Register a citizen account")
    @ApiResponses({
    ...
    @ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "403", description = "Account disabled or blocked")
    })
    @PostMapping("/login")
